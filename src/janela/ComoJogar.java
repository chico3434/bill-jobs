...
public class ComoJogar extends Stage{
	
	String comoJogar = "O jogo Bill Jobs: Money Machine tem como objetivo a acumulação máxima de capital provindos de vendas de produtos tecnológicos.\n" + 
			"\n" + 
			"Todo produto tem:\n" + 
			...
			"Possui como infraestrutura o Servidor.\n" + 
			...
			"-Servidor: Servidor é uma estrutura exclusiva de softwares, que possui um número de espaço de armazenamento.\n" + 
			...
			"\n" + 
			"-Fábrica: A fábrica é um estrutura exclusiva de hardwares, que possui a capacidade de produzir somente um tipo de hardware.\n" + 
			"A fábrica possui níveis, que são o quão complexo os hardwares podem ser para ela produzir, a complexidade do hardware é maior, quando seu custo for maior.\n" + 
			...
			"As fábricas possuem um potencial, que é o quanto ela consegue produzir funcionando em 100%. Em um mês podem ser produzidos 100%, 75%, 50%, 25%, 0% do potencial. E isto depende primeiramente de condições aleatórias e segundamente de condições financeiras, se sua empresa não tiver verba para produzir algum produto ele não será produzido.\n" + 
			"\n" + 
			...
			"\n" + 
			"O jogo possui uma interface que te possibilite comprar infraestruturas, criar produtos, usar as infraestruturas ver os detalhes de cada infraestrutura ou produto e passar o tempo.\n" + 
			"\n" + 
			"É possível comprar uma infraestrutura clicando no botão Comprar que fica ao lado das infraestruturas.\n" + 
			"\n" + 
			...
			"\n" + 
			"É possível criar um produto clicando no botão Criar ao lado de Produtos e preenchendo a tela que se abre com os dados do produto.\n" + 
			"\n" + 
			"É possível ver os detalhes clicando no id de qualquer elemento na parte \"Principal\" da tela. \n" + 
			...
			"Os detalhes aparecem na parte \"Detalhes\" da tela.\n" + 
			"\n" + 
			...
			"\n" + 
			"É possível salvar os dados de seu empresário clicando no Menu Jogo e depois no sub-menu Salvar.\n" + 
			"É possível sair do jogo clicando no Menu Jogo e depois no sub-menu Sair.\n" + 
	...
	public ComoJogar() {
		...
		painel.setContent(new Label(comoJogar));
